...
export async function searchChatbot(query) {
  ...
  if (['help', 'support'].includes(lowerQuery)) {
    return { type: 'text', text: "I'm here to help! I can answer questions about our products, ingredients, shipping, and return policies. Try asking 'What is Kumkumadi oil?'" };
  }
