...
export default function Logo({ className = "w-10 h-10", showText = true }) {
  ...
  return (
    <div className="flex items-center gap-3">
      {!useFallback ? (
        <img
          src="/Advayur-Logo.png"
          alt="Advayur Logo"
          className={`${className} object-contain`}
          onError={() => setUseFallback(true)}
        />
      ) : (
        /* Premium SVG Leaf Logo Emblem (Fallback if /logo.png is not found) */
        <svg
        ...
        >
          ...
          <path
            ...
            fillOpacity="0.9"
          />
          <path d="M50 20V78" stroke="#fdfbf7" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M50 38Q56 42 58 46" stroke="#fdfbf7" strokeWidth="1" strokeLinecap="round" />
          <path d="M50 48Q58 52 59 58" stroke="#fdfbf7" strokeWidth="1" strokeLinecap="round" />
          <path d="M50 42Q44 46 42 50" stroke="#fdfbf7" strokeWidth="1" strokeLinecap="round" />
          <path d="M50 52Q42 56 41 62" stroke="#fdfbf7" strokeWidth="1" strokeLinecap="round" />
        </svg>
      )}
